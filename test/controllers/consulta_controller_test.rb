...
class ConsultaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consultum" do
    assert_difference('Consultum.count') do
      post consulta_url, params: { consultum: { data_consulta: @consultum.data_consulta, medico_id: @consultum.medico_id, paciente_id: @consultum.paciente_id } }
    end
  ...
  test "should update consultum" do
    patch consultum_url(@consultum), params: { consultum: { data_consulta: @consultum.data_consulta, medico_id: @consultum.medico_id, paciente_id: @consultum.paciente_id } }
